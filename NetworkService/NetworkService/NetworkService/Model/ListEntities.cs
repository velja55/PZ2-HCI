...
namespace NetworkService.Model
{
    public static class ListEntities
    {
		public static ObservableCollection<PressureInVentil> pressureInVentils=new ObservableCollection<PressureInVentil>() { new PressureInVentil(0, "Cable1", "Cable sensor", "C:\\Users\\lukic\\Desktop\\fax3.godina\\2.semestar\\HCI\\PZ2Z\\PZ2-HCI\\NetworkService\\NetworkService\\NetworkService\\Images\\cable.jpg"),
                        new PressureInVentil(1, "Digital1", Resources.DigitalManometarString, "C:\\Users\\lukic\\Desktop\\fax3.godina\\2.semestar\\HCI\\PZ2Z\\PZ2-HCI\\NetworkService\\NetworkService\\NetworkService\\Images\\digital.jpg"),
                        new PressureInVentil(3, "Digital2", Resources.DigitalManometarString,"C:\\Users\\lukic\\Desktop\\fax3.godina\\2.semestar\\HCI\\PZ2Z\\PZ2-HCI\\NetworkService\\NetworkService\\NetworkService\\Images\\digital.jpg"),
                        new PressureInVentil(2, "Cable2", Resources.CableSensorString, "C:\\Users\\lukic\\Desktop\\fax3.godina\\2.semestar\\HCI\\PZ2Z\\PZ2-HCI\\NetworkService\\NetworkService\\NetworkService\\Images\\cable.jpg")

        } ;

        public static ObservableCollection<Canvas> collectionCanvas=new ObservableCollection<Canvas>() { new Canvas()
                    {
                        Background = (Brush)(new BrushConverter().ConvertFrom(Resources.LightBlueColor)),
                        AllowDrop = true
                    }, new Canvas()
                    {
                        Background = (Brush)(new BrushConverter().ConvertFrom(Resources.LightBlueColor)),
        ...
        public static ObservableCollection<string> borderBrushes= new ObservableCollection<string>() { Resources.BlackColor, Resources.BlackColor, Resources.BlackColor, Resources.BlackColor, Resources.BlackColor, Resources.BlackColor, Resources.BlackColor, Resources.BlackColor, Resources.BlackColor, Resources.BlackColor, Resources.BlackColor, Resources.BlackColor, Resources.BlackColor, Resources.BlackColor };
        public static ObservableCollection<string> GridBackgrounds = new ObservableCollection<string>() { Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite, Resources.ColorWhite };

        public static bool adding = true;

        public static EntitiesByType digitalEntities = new EntitiesByType(Resources.DigitalManometarString);
        public static EntitiesByType cableEntities = new EntitiesByType(Resources.CableSensorString);
